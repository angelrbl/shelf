    ...
    with ui.card().classes('absolute-center w-80 sm:w-100 shadow-lg rounded-lg'):
        ...
        with ui.tab_panels(tabs, value=login_tab).classes('w-full bg-transparent'):
            ...
            with ui.tab_panel(login_tab):
                ...
                login_password = user_input('Password', icon='lock', password=True, password_toggle_button=True).on('keydown.enter', handle_login)
            ...
            with ui.tab_panel(register_tab):
                ...
                reg_password_repeat = user_input('Repeat password', icon="password", password=True, password_toggle_button=True).on('keydown.enter', handle_register)
